...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  $("li").on("click", event => {
    const $sqLi = $(event.currentTarget);

    const pos = $sqLi.data("pos");
...
View.prototype.exercise7 = function(){
  ...
  //your code here!
  $("li").on("mouseenter", (e) => {
    const $squareLi = $(e.currentTarget);
    const square = $squareLi.data("square");
    console.log(square.background-color);
  });
};
